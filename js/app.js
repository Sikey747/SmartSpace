(() => {
    ...
    (() => {
        ...
        function scrollFunction() {
            ...
            if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) document.documentElement.classList.add("down-scroll"); else if (document.body.scrollTop < 100 || document.documentElement.scrollTop < 100) document.documentElement.classList.remove("down-scroll");
        }
